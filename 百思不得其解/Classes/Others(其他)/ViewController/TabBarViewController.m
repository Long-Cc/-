...
- (void) setupChildViewControllers {
    ...
    [self setupOneChildViewController:[[CLNavigationController alloc] initWithRootViewController:[[CLMeViewController alloc] init]] title:@"我" image:@"tabBar_me_icon" selectedImage:@"tabBar_me_click_icon"];
